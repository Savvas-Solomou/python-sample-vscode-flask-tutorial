[![Build Status](https://dev.azure.com/ssolomou/TestProject/_apis/build/status/Savvas-Solomou.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/ssolomou/TestProject/_build/latest?definitionId=1&branchName=master)
